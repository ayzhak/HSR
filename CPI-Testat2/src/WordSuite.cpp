...
void constructor_test_with_string() {
	Word const w { "abc" };
	std::ostringstream outputString {};
	outputString << w;

	ASSERT_EQUAL("abc", outputString.str());
}
...
void onewordTest() {
	Word const word { };
	std::istringstream inputString {"abc"};
	std::ostringstream outputString {};
...
void twowordTest() {
	Word const word { };
	std::istringstream inputString {".abc.....efg"};
	std::ostringstream outputString {};

	inputString >> word;
	inputString >> word;
	outputString << word;
	ASSERT_EQUAL("efg", outputString.str());
}

void equal_test() {
	Word const left { "abc" };
	Word const rigth { "abc" };
	ASSERT(left == rigth);
}

void not_equal_test() {
	Word const left { "abc" };
	Word const rigth { "abce" };
	ASSERT(left != rigth);
}
...
cute::suite make_suite_wordSuite() {
	cute::suite s { };

	s.push_back(CUTE(onewordTest));
	s.push_back(CUTE(twowordTest));
	s.push_back(CUTE(constructor_test_with_string));
	s.push_back(CUTE(constructor_exception_test));
	s.push_back(CUTE(equal_test));
	s.push_back(CUTE(not_equal_test));
